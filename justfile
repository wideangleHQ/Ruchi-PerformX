...
# time when missing.
server_env_required := "DATABASE_URL DIRECT_URL JWT_SECRET VMS_JWT_SECRET ASSET_ENCRYPTION_KEY INTERNAL_API_KEY RESEND_API_KEY RESEND_FROM_EMAIL SUPABASE_URL SUPABASE_SERVICE_ROLE_KEY SUPABASE_BUCKET SUPABASE_VMS_BUCKET"
